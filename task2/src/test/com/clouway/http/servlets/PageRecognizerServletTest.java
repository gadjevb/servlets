...
public class PageRecognizerServletTest {
    ...
    public void happyPath() throws ServletException, IOException {
        PageRecognizerServlet recognizerServlet = new PageRecognizerServlet(links);
        StringWriter stringWriter = new StringWriter();
        PrintWriter printWriter = new PrintWriter(stringWriter);
        context.checking(new Expectations() {
            {
                oneOf(request).getParameter("action");
        ...
        CharSequence secondExpected = "You came here from the page with the RED button!";
